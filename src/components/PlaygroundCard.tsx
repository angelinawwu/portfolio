...
export default function PlaygroundCard({ project, index }: PlaygroundCardProps) {
  ...
  const cardContent = (
    ...
    >
      ...
      <div className={`absolute bottom-0 left-0 right-0 bg-black flex items-center justify-between px-4 py-3 ${captionVisibility} transition-all duration-200 ease-out z-10 border-t border-faded-white`}>

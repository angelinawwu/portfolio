...
`;
    ...
    class ExternalForce extends ShaderPass {
      ...
      initMouse(simProps: SimulationProps) {
        super.init();
        const mouseG = new THREE.PlaneGeometry(1, 1);
        const cursorSize = simProps.cursor_size || 100;
    ...
    class Viscous extends ShaderPass {
      ...
      update(props?: UpdateProps): THREE.WebGLRenderTarget | undefined {
        ...
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
            fbo_in = this.props.output0 as THREE.WebGLRenderTarget | undefined;
            fbo_out = this.props.output1 as THREE.WebGLRenderTarget | undefined;
          } else {
            fbo_in = this.props.output1 as THREE.WebGLRenderTarget | undefined;
            fbo_out = this.props.output0 as THREE.WebGLRenderTarget | undefined;
          }
        ...
        return fbo_out as THREE.WebGLRenderTarget | undefined;
      }
    }
    ...
    class Poisson extends ShaderPass {
      ...
      update(props?: UpdateProps): THREE.WebGLRenderTarget | undefined {
        ...
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
            p_in = this.props.output0 as THREE.WebGLRenderTarget | undefined;
            p_out = this.props.output1 as THREE.WebGLRenderTarget | undefined;
          } else {
            p_in = this.props.output1 as THREE.WebGLRenderTarget | undefined;
            p_out = this.props.output0 as THREE.WebGLRenderTarget | undefined;
          }
          if (this.uniforms) this.uniforms.pressure.value = (p_in as THREE.WebGLRenderTarget)?.texture;
          this.props.output = p_out;
          super.update();
        }
        return p_out as THREE.WebGLRenderTarget | undefined;
      }
    }

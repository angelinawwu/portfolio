      ...
      <main className="pt-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <section className="py-12">
            <h1 className="text-4xl md:text-5xl font-medium text-blue mb-8">Manifesto Market</h1>
          ...
          <section className="py-12 border-t border-blue/10">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-blue mb-6"><ShinyText text="Users aren't being driven towards reservations." /></h3>
                <div className="space-y-6 text-blue leading-relaxed">
                  <p>
          ...
          <section className="py-12 border-t border-blue/10">
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-blue mb-6">Understanding our users</h3>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="w-full h-auto bg-surface border border-blue/10 rounded-lg flex items-center justify-center overflow-hidden">
                    <Image
                ...
                <div className="space-y-8">
                  <div className="border border-blue/10 rounded-lg p-8 bg-surface">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-xl font-medium text-blue mb-4">Conversion is lost in the reservation process.</h4>
                  ...
                  <div className="border border-blue/10 rounded-lg p-8 bg-surface">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-xl font-medium text-blue mb-4">User diversity reflects an international audience.</h4>
                        <p className="text-blue leading-relaxed">
                  ...
                  <div className="border border-blue/10 rounded-lg p-8 bg-surface">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-xl font-medium text-blue mb-4">Mobile-first is essential.</h4>
                        <p className="text-blue leading-relaxed">
          ...
          <section className="py-12 border-t border-blue/10">
            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="w-full h-auto bg-surface border border-blue/10 rounded-lg overflow-hidden mb-6">
                  <video
                ...
                <div>
                <h3 className="text-xl md:text-2xl font-medium text-blue mb-6 mt-12">CTAs built for conversion</h3>
                <p className="text-blue leading-relaxed mb-6">
              ...
              <div>
                <h3 className="text-xl md:text-2xl font-medium text-blue mb-6">Intuitive navigation</h3>
                <p className="text-blue leading-relaxed mb-6">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-blue mb-6">Unexpected limitations...</h3>
                <p className="text-blue leading-relaxed mb-6">
            ...
            <div className="space-y-6">
              <div className="border border-blue/10 rounded-lg p-6 bg-surface">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-xl font-medium text-blue mb-2">121% increase in reservation conversions from the reservation page.</h4>
                    <p className="text-blue leading-relaxed">
              ...
              <div className="border border-blue/10 rounded-lg p-6 bg-surface">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-xl font-medium text-blue mb-2">Adapting the project for a new vision.</h4>
                    <p className="text-blue leading-relaxed">
              ...
              <div className="border border-blue/10 rounded-lg p-6 bg-surface">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-xl font-medium text-blue mb-2">Creating a mobile-friendly experience.</h4>
                    <p className="text-blue leading-relaxed">

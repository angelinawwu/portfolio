        ...
        <div className="max-w-4xl mx-auto md:px-6 px-4">
          ...
          <section className="py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              ...
              <div className="border border-white/10 rounded-lg p-6">
                ...
                <p className="text-white font-medium">Jun - Aug 2025</p>
              </div>
              <div className="border border-white/10 rounded-lg p-6">
                <h3 className="text-white/60 text-sm font-medium mb-2">Team</h3>
                <p className="text-white font-medium">1 Designer<br />1 Developer<br />2 Supervisors</p>
              </div>
              <div className="border border-white/10 rounded-lg p-6">
                <h3 className="text-white/60 text-sm font-medium mb-2">Tools</h3>
                <p className="text-white font-medium">Figma<br />Wordpress</p>
              </div>
            </div>
          </section>
          ...
          <section className="py-12 border-t border-white/10">
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-white mb-6">Understanding our users</h3>
                ...
                <div className="space-y-8">
                  ...
                  <div className="border border-white/10 rounded-lg p-8">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-xl font-medium text-white mb-4">Mobile-first is essential.</h4>
                        <p className="text-white/80 leading-relaxed">
            ...
            <div className="space-y-6">
              <div className="border border-white/10 rounded-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-xl font-medium text-white mb-2">121% increase in reservation conversions from the reservation page.</h4>
                    <p className="text-white/80 leading-relaxed">
              ...
              <div className="border border-white/10 rounded-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-xl font-medium text-white mb-2">Creating a mobile-friendly experience.</h4>
                    <p className="text-white/80 leading-relaxed">

        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <section className="py-12">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              ...
              <div className="border border-white/10 rounded-lg p-6">
                ...
                <p className="text-white font-medium">Jan - Jun 2025</p>
              </div>
              <div className="border border-white/10 rounded-lg p-6">
                <h3 className="text-white/60 text-sm font-medium mb-2">Team</h3>
                <p className="text-white font-medium">14 Designers<br />1 Product Team</p>
              </div>
              <div className="border border-white/10 rounded-lg p-6">
          ...
          <section className="py-12 border-t border-white/10">
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-white mb-6">Understanding the Current Market</h3>
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-white mb-6">Getting to the Root</h3>
                <p className="text-white/80 leading-relaxed">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-white mb-8">Key Findings</h3>
                ...
                <div className="space-y-8">
                  <div className="border border-white/10 rounded-lg p-8">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-xl font-medium text-white mb-4">An unclear user flow leaves users confused.</h4>
                        <p className="text-white/80 leading-relaxed">
                  ...
                  <div className="border border-white/10 rounded-lg p-8">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-xl font-medium text-white mb-4">Feedback formatting overwhelms users.</h4>
                        <p className="text-white/80 leading-relaxed">
                  ...
                  <div className="border border-white/10 rounded-lg p-8">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-xl font-medium text-white mb-4">Lack of organization options limits usefulness.</h4>
                        <p className="text-white/80 leading-relaxed">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-white mb-6">Putting Faces to the Data</h3>
                <p className="text-white/80 leading-relaxed mb-6">
          ...
          <section className="py-12 border-t border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="border border-white/10 rounded-lg p-8">
                <h3 className="text-xl font-medium text-white mb-4">Empower confident <span className="rainbow-text">preparation</span>.</h3>
                <p className="text-white/80 leading-relaxed">
                  Enable users to practice interviews and receive actionable AI feedback, helping them build skills and self-assurance.
                </p>
              </div>
              <div className="border border-white/10 rounded-lg p-8">
                <h3 className="text-xl font-medium text-white mb-4">Streamline the user <span className="rainbow-text">journey</span>.</h3>
                <p className="text-white/80 leading-relaxed">
                  Design an intuitive user flow that minimizes friction and confusion, reducing the focus required for navigation.
                </p>
              </div>
              <div className="border border-white/10 rounded-lg p-8">
                <h3 className="text-xl font-medium text-white mb-4">Support continuous <span className="rainbow-text">improvement</span>.</h3>
                <p className="text-white/80 leading-relaxed">
          ...
          {/* Design */}
          <section className="py-12 border-t border-white/10">
            <h2 className="text-3xl md:text-4xl font-medium text-white mb-8">Design</h2>
            ...
            <div className="space-y-12">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-medium text-white mb-6">Iterate, iterate, iterate...</h3>
                <p className="text-white/80 leading-relaxed mb-6">
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div>
                    <h4 className="text-xl font-medium text-white mb-4">Practice built for perfect</h4>
                    <p className="text-white/80 leading-relaxed mb-6">
                  ...
                  <div>
                    <h4 className="text-xl font-medium text-white mb-4">Scheduling that feels seamless</h4>
                    <p className="text-white/80 leading-relaxed mb-6">
                  ...
                  <div>
                    <h4 className="text-xl font-medium text-white mb-4">Feedback that drives improvement</h4>
                    <p className="text-white/80 leading-relaxed mb-6">
